...
public class DirectoryTests : Demo
{
    ...
    public void Test()
    {
        ...
        Assert.AreEqual(Directory.GetCurrentDirectory(),
            @"D:\Liang\git\dotnet\dotnet6\dotnet6Tests\bin\Debug\net6.0");
    ...
    public void Enumerate()
    {
        ...
        IEnumerable<string> enumerateDirectories =
            Directory.EnumerateDirectories(DotNet6Path, "*", SearchOption.AllDirectories);
        ...
        IEnumerable<string> files = Directory.EnumerateFiles(DotNet6Path);
