...
### [Conventional Route](https://docs.microsoft.com/zh-cn/aspnet/core/mvc/controllers/routing#attribute-routing-for-rest-apis)
```
/** Program.cs */
...
```
### [Attribute Route](https://docs.microsoft.com/zh-cn/aspnet/core/mvc/controllers/routing#attribute-routing-for-rest-apis)
```
/** Program.cs */
app.MapControllers();
```
...
### [HttpRepl](https://docs.microsoft.com/zh-cn/aspnet/core/web-api/http-repl/)
```shell
# 安装
